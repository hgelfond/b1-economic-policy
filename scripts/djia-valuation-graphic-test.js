(function() {
  ...
  chart.append('g')
      .append('line')
      .attr('class', 'line2')
      .attr('x', (c) => xScale(c.sector))
      .attr('y', (c) => yScale(c.value))
      .attr('height', (c) => height - yScale(c.value))
    ...
    .on('mouseenter', function (actual, i) {
        ...
        /* Tried adding way to have y values hover over */
        barGroups.append('text')
          .attr('class','p_e_id')
          .transition()
          .duration(500)
          .delay(80)
          .attr('x', (b) => xScale(b.sector) + xScale.bandwidth() / 2)
          .attr('y', (b) => yScale(b.value) - 30)
          .attr('fill', 'white')
          .attr('text-anchor', 'middle')
